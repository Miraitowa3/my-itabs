  ...
  <div class="registry">
    ...
    <el-form ref="ruleFormRef" :model="ruleForm" :rules="rules">
      ...
      <el-form-item prop="code">
        <el-input v-model="ruleForm.code" type="text" placeholder="请输入6位邮箱验证码" clearable />
      </el-form-item>
      <el-form-item prop="username">
        <el-input v-model="ruleForm.username" type="text" placeholder="请输入用户名" clearable />
      </el-form-item>
      <el-form-item prop="password">
        <el-input v-model="ruleForm.password" type="password" autocomplete="off" placeholder="请输入8 到 18 位密码" clearable
          @blur="handlePasswordBlur" @focus="handlePasswordFocus" />
      </el-form-item>
      <el-form-item>
        <div class="h-10 w-full leading-none">
          <el-button type="primary" @click="submitForm(ruleFormRef)" style="height: 100%; width: 100%"> 立即注册
          </el-button>
        </div>
      </el-form-item>
    </el-form>
...
function handleEmilChange() {
  ...
  if (validateEmil(ruleForm.value.email)) {
    isEmil.value = true;
...
const valiCode = (rule: any, value: any, callback: any) => {
...
const vailUsername = (rule: any, value: any, callback: any) => {
...
const rules = reactive<FormRules<typeof ruleForm>>({
  ...
  code: [{ validator: valiCode, trigger: 'change' }],
  username: [{ validator: vailUsername, trigger: 'change' }],
